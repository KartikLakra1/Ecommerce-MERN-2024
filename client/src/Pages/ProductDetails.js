...
const ProductDetails = () => {
    ...
    return (
        <Layout>
            <div className="flex items-center flex-col justify-center gap-6 w-[100%] lg:p-11 p-3 mt-5 mb-5 " >
                <div className="flex flex-col justify-around items-center lg:flex-row lg:w-[60%] w-[90%] shadow-2xl lg:h-[60vh] h-fit p-3">
                ...
                <div className="text-center">
                    <h1 className="font-3xl underline font-bold">Similar Products</h1>
